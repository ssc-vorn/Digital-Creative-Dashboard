...
const { data: featuredList } = useAsyncData('work-index-featured', () => projectRepository.getFeaturedProjects())
...
<template>
  <div>
    <SiteWorkFeaturedProject v-if="featured" :project="featured" />

    <div class="site-container pb-24 pt-16 sm:pb-32 sm:pt-20">
